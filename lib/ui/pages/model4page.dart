...
class Model4Page extends ConsumerStatefulWidget {
  ...
  const Model4Page({super.key, this.model});

  @override
  ConsumerState<Model4Page> createState() => _Model4PageState();
}

class _Model4PageState extends ConsumerState<Model4Page> {
  @override
  void initState() {
    super.initState();
